...
const file_proto_user_v1_user_proto_rawDesc = "" +
	"\n" +
	"\x18proto/user/v1/user.proto\x12\auser.v1\"\x11\n" +
	"\x0fGetUsersRequest\"@\n" +
	"\x04User\x12\x0e\n" +
	...
	"\x05users\x18\x01 \x03(\v2\r.user.v1.UserR\x05users2N\n" +
	"\vUserService\x12?\n" +
	"\bGetUsers\x12\x18.user.v1.GetUsersRequest\x1a\x19.user.v1.GetUsersResponseB Z\x1euser-service/gen/userpb;userpbb\x06proto3"
...
var file_proto_user_v1_user_proto_depIdxs = []int32{
	1, // 0: user.v1.GetUsersResponse.users:type_name -> user.v1.User
	0, // 1: user.v1.UserService.GetUsers:input_type -> user.v1.GetUsersRequest
	2, // 2: user.v1.UserService.GetUsers:output_type -> user.v1.GetUsersResponse
